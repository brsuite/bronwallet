...
var datadir = bronutil.AppDataDir("bronwallet", false)
...
func mainInt() int {
	...
	for !opts.Force {
		fmt.Print("Drop all bronwallet transaction history? [y/N] ")
	...
	fmt.Println("Dropping bronwallet transaction history")
