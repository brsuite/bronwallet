...
import (
	...
	"github.com/brsuite/bronwallet/rpc/legacyrpc"
...
// startChainRPC opens a RPC client connection to a brond server for blockchain
...
func startChainRPC(certs []byte) (*chain.RPCClient, error) {
	...
	rpcc, err := chain.NewRPCClient(activeNet.Params, cfg.RPCConnect,
		cfg.BrondUsername, cfg.BrondPassword, certs, cfg.DisableClientTLS, 0)
	if err != nil {
		return nil, err
	}
	err = rpcc.Start()
