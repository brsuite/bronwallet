...
func (m *Manager) MarkUsed(ns walletdb.ReadWriteBucket, address bronutil.Address) error {
	m.mtx.RLock()
	defer m.mtx.RUnlock()
...
func (m *Manager) AddrAccount(ns walletdb.ReadBucket,
	address bronutil.Address) (*ScopedKeyManager, uint32, error) {
...
func (m *Manager) ForEachActiveAddress(ns walletdb.ReadBucket, fn func(addr bronutil.Address) error) error {
	m.mtx.RLock()
	defer m.mtx.RUnlock()
