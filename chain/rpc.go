...
func (c *RPCClient) Rescan(startHash *chainhash.Hash, addrs []bronutil.Address,
...
func parseBlock(block *bronjson.BlockDetails) (*wtxmgr.BlockMeta, error) {
	if block == nil {
		return nil, nil
	}
...
func (c *RPCClient) onRecvTx(tx *bronutil.Tx, block *bronjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *bronutil.Tx, block *bronjson.BlockDetails) {
