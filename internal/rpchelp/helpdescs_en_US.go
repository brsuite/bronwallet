...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in brocoin",
	"getbalance--result1":    "The balance of all accounts valued in brocoin",
	...
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in BRON/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in brocoin",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in brocoin",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in brocoin",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and brocoin amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in brocoin",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in brocoin",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in brocoin",
	...
	"listtransactionsresult-amount":             "The value of the transaction output valued in brocoin",
	...
	"listunspentresult-amount":        "The amount of the output valued in brocoin",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in brocoin",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in brocoin to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in brocoin",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in brocoin",
	...
	"settxfee-amount":    "The new fee increment valued in brocoin",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in brocoin.",
