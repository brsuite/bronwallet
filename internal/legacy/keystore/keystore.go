...
func (a *btcAddress) Address() bronutil.Address {
	return a.address
}
...
func (a *btcAddress) ExportPrivKey() (*bronutil.WIF, error) {
	pk, err := a.PrivKey()
	if err != nil {
		return nil, err
	}
	...
	// elsewhere.
	wif, err := bronutil.NewWIF((*btcec.PrivateKey)(pk), a.store.netParams(),
		a.Compressed())
	if err != nil {
		panic(err)
	}
...
// address returns a bronutil.AddressScriptHash for a btcAddress.
